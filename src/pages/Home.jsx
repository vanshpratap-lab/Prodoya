...
export default function Home({ setCurrentPage }) {
  ...
  return (
    <div className="home-page animate-fade-in-up">
      ...
      {/* Why MarkZap Section */}
      <section className="why-markzap section-light">
        <div className="container">
          <div className="section-header">
            <span className="tag-badge">Why MarkZap</span>
            <h2 className="section-title-large">Built different. Built to grow.</h2>
            <p className="section-desc-large">
              Most agencies deliver assets. We deliver outcomes. The difference is in how we think — strategy first, execution second, optimization always.
            </p>
          </div>

          <div className="reasons-grid">
            <div className="reason-card">
              <h3 className="reason-title">End-to-End Execution</h3>
              <p className="reason-text">One unified team, zero handoff gaps — from strategy to post-launch.</p>
            </div>
            <div className="reason-card">
              <h3 className="reason-title">AI-Powered Systems</h3>
              <p className="reason-text">Automation that lets your business scale without scaling headcount.</p>
            </div>
            <div className="reason-card">
              <h3 className="reason-title">Faster Launch Cycles</h3>
              <p className="reason-text">Structured sprints that consistently cut time-to-market by 60%.</p>
            </div>
            <div className="reason-card">
              <h3 className="reason-title">Growth-Focused Design</h3>
              <p className="reason-text">Every visual decision is tied to a business metric, not just aesthetics.</p>
            </div>
            <div className="reason-card">
              <h3 className="reason-title">Strategic Thinking</h3>
              <p className="reason-text">We refuse to design before we understand. Research always comes first.</p>
            </div>
            <div className="reason-card">
              <h3 className="reason-title">Dedicated Partnership</h3>
              <p className="reason-text">A senior team on your account — not interns, not outsourced.</p>
            </div>
          </div>
        </div>
      </section>
